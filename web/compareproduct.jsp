...
<!-- Nav -->
        ...
        <nav class="mobileUI-site-nav"> <a href="userpage.jsp" class="active">View All Items </a> <a href="searchproduct.jsp">Search Items  </a> <a href="userlogin.jsp">Logout</a></nav>
      </div>
    </div>
  </header>
</div>
   ...
   String username2 = session.getAttribute("username").toString();
                                        ...
                                        try {
                                            //String username = "username";
											 String searchinput = request.getParameter("searchinput1");
		...
		int count =0;
                                      ...
                                      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/restaurant","root","password");
									   String query1 = "select * from productdetails where name like '%"+searchinput+"%'"; 
									  ...
									  double genrate=(double)((double)total/(double)count);
                                            String query = "select * from productdetails where name like '%"+searchinput+"%'"; 
									 ...
									 double prob = (double)((double)((double)price-(double)genrate)/(double)genrate);
									 
									 prob=(double)((double)prob*(double)100);
          ...
          <tr>
            ...
            <td><div align="center"><%=prob2%></div></td>
          </tr>
          <%
